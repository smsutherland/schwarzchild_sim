from ._inner import BodyParameters, schwarzchild_radius, Solvers
from typing import Optional, Union
import numpy as np
import matplotlib.pyplot as plt
from astropy import units as u, constants as c

mercury_orbit = BodyParameters(_inner.M_SUN, 6.9818e10, 0., 0., 3.886e4 / 6.9818e10)
small_precession = BodyParameters(_inner.M_SUN, schwarzchild_radius(_inner.M_SUN) * 200., 0., 0., 35.)
...
__all__ = [
    "BodyParameters", "mercury_orbit", "Solvers",
